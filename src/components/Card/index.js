...
export default function Card() {
    ...
    const cardInfo = [
        ...
        },
        {
            ...
            text: "This is a Node CLI (Command-line interface) which takes in information about employees, and generates an HTML webpage which displays summaries for each person.",
